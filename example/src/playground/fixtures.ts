...
export function createAdvancedPlaygroundFixture(): DashboardWidget<ExampleWidgetData>[] {
  return [
    createWidget("sales", "매출", 0, 0, 3, 2, { description: "월간 반복 매출", value: "1.28억" }),
    createWidget("traffic", "트래픽", 3, 0, 3, 2, { description: "활성 세션", value: "4.28만" }),
    createWidget("orders", "주문", 0, 2, 2, 2, { description: "완료 주문", value: "1,284" }),
    createWidget("alerts", "알림", 2, 2, 4, 2, { description: "미해결 이슈", value: "3" }),
  ];
}
